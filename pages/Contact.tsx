...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>GreenSydney Landscapes | Contact</title>
        <meta
          name="description"
          content="Get in touch with GreenSydney Landscapes for expert garden design, landscaping, and lawn care services across Sydney. Request a free quote today."
        />
      </Helmet>
      ...
      <div className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            <h1 className="text-5xl md:text-7xl font-bold text-stone-900 mb-8">
              Get In Touch
            </h1>
            <p className="text-xl text-stone-700 max-w-2xl mx-auto font-medium">
              ...
              reach out to us directly for a free consultation.
            </p>
          </div>
                ...
                <div className="space-y-10">
                  {[
                    ...
                    },
                    {
                      ...
                      label: "Email",
                      val: "info@greensydneylandscapes.com.au",
                      desc: "Fast response within 24h",
                    },
                    {
                      icon: <MapPin className="w-7 h-7" />,
                      label: "Office",
                      val: "123 Gardenia Ave, North Sydney",
                      desc: "Visit our design studio",
                    },
                  ].map((item, idx) => (
                    <div key={idx} className="flex gap-8 group">
                      ...
                      <div>
                        ...
                        {item.label === "Email" ? (
                          <p className="text-2xl font-bold text-stone-900 mb-1 break-words max-w-xs">
                            <a
                        ...
                        <p className="text-stone-600 font-bold text-sm uppercase tracking-wide opacity-80">
                          {item.desc}
                        </p>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-6 text-stone-300 font-bold text-sm">
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-3">
                      <Globe className="w-4 h-4 text-emerald-500" /> {area}
                    </div>
                  ))}
                </div>
                ...
                {!submitted ? (
                  <form className="space-y-8" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <label className="text-xs font-black text-stone-900 uppercase tracking-widest ml-1">
                          Full Name
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-stone-700 text-xl leading-relaxed font-medium">
                      Thank you for your interest. One of our lead designers will
          ...
          <div className="mt-24">
            <div className="bg-white rounded-[4rem] overflow-hidden h-[600px] shadow-2xl relative border-8 border-white p-1">
              ...
              <div className="absolute top-10 left-10 bg-white/95 backdrop-blur-xl p-8 rounded-[2rem] shadow-2xl max-w-xs border border-white/50">
                <h4 className="font-black text-stone-900 mb-3 text-lg">
                  Our Design Studio
                </h4>
                <p className="text-stone-700 text-sm font-bold mb-6">
                  123 Gardenia Ave, North Sydney, NSW 2060
                </p>
                <a
